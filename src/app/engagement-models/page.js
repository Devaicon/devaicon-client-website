  ...
  const engagementModelsData = [
    {
      ...
      technologies: [
        { name: "React", logo: "/logo.svg", width: 80, height: 80 },
        { name: "Node.js", logo: "/logo.svg", width: 80, height: 80 },
        { name: "Python", logo: "/logo.svg", width: 80, height: 80 },
        { name: "AWS", logo: "/logo.svg", width: 80, height: 80 },
        { name: "Docker", logo: "/logo.svg", width: 80, height: 80 },
      ],
    },
    {
      ...
      technologies: [
        { name: "Angular", logo: "/logo.svg", width: 80, height: 80 },
        { name: "Vue.js", logo: "/logo.svg", width: 80, height: 80 },
        { name: "Java", logo: "/logo.svg", width: 80, height: 80 },
        { name: "Azure", logo: "/logo.svg", width: 80, height: 80 },
        { name: "MongoDB", logo: "/logo.svg", width: 80, height: 80 },
      ],
    },
    {
      ...
      technologies: [
        { name: "TypeScript", logo: "/logo.svg", width: 80, height: 80 },
        { name: "GraphQL", logo: "/logo.svg", width: 80, height: 80 },
        { name: ".NET", logo: "/logo.svg", width: 80, height: 80 },
        { name: "Kubernetes", logo: "/logo.svg", width: 80, height: 80 },
        { name: "PostgreSQL", logo: "/logo.svg", width: 80, height: 80 },
      ],
    },
  ];
