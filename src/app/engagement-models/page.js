  ...
  const engagementModelsData = [
    {
      ...
      technologies: [
        { name: "React", logo: "/react.svg", width: 80, height: 80 },
        { name: "Node.js", logo: "/node.svg", width: 80, height: 80 },
        { name: "Python", logo: "/python.svg", width: 80, height: 80 },
        { name: "AWS", logo: "/aws.svg", width: 80, height: 80 },
        { name: "Docker", logo: "/docker.svg", width: 80, height: 80 },
      ],
    },
    {
      ...
      technologies: [
        { name: "Angular", logo: "/angular.svg", width: 80, height: 80 },
        { name: "Vue.js", logo: "/vue.svg", width: 80, height: 80 },
        { name: "Java", logo: "/java.svg", width: 80, height: 80 },
        { name: "Azure", logo: "/azure.svg", width: 80, height: 80 },
        { name: "MongoDB", logo: "/mongo.svg", width: 80, height: 80 },
      ],
    },
    {
      ...
      technologies: [
        { name: "TypeScript", logo: "/typescript.svg", width: 80, height: 80 },
        { name: "GraphQL", logo: "/graphql.svg", width: 80, height: 80 },
        { name: ".NET", logo: "/dotnet.svg", width: 80, height: 80 },
        { name: "Kubernetes", logo: "/kubernetes.svg", width: 80, height: 80 },
        { name: "PostgreSQL", logo: "/postgres.svg", width: 80, height: 80 },
      ],
    },
  ];
