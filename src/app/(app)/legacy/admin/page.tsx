...
export default function AdminPage() {
  ...
  return (
    <main className="min-h-screen bg-neutral-50">
      <div className="bg-amber-50 border-b border-amber-200 px-6 py-2 text-xs text-amber-900 flex items-center justify-between gap-4 print:hidden">
        <span>
          <strong>Legacy backend</strong> · Google Sheets · for data migration only.
        </span>
        <a href="/admin" className="underline hover:text-amber-950 whitespace-nowrap">
          Go to new backend →
        </a>
      </div>
