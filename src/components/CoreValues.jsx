  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden w-full py-8">
        {/* Center Header */}
        <div className="bg-brand-accent rounded-2xl p-6 mb-8 shadow-lg text-center">
        ...
        <div className="space-y-4">
          {data.items.map((item) => (
            ...
            >
              <div className="w-16 h-16 rounded-xl flex items-center justify-center shadow-md shrink-0 bg-white">
      ...
      <div className="hidden lg:block relative w-full max-w-5xl h-96">
        ...
        <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-86 h-86">
        ...
        <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-86 h-86 border-2 border-dashed rounded-full opacity-50"></div>
        ...
        {/* Center Circle */}
        <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-brand-accent rounded-full flex flex-col items-center justify-center p-6 shadow-[0_0_30px_rgba(255,255,255,0.4)]">
        ...
        {/* Top Left Item */}
        <div className="absolute -top-30 -left-10 flex items-start gap-3 max-w-sm">
        ...
        {/* Top Right Item */}
        <div className="absolute -top-30 -right-10 flex items-start gap-3 max-w-sm">
          <div className="w-20 h-20 rounded-xl flex items-center justify-center shadow-md shrink-0 bg-white">
        ...
        {/* Left Item */}
        <div className="absolute -bottom-5 -left-10 transform -translate-y-1/2 flex items-start gap-3 max-w-sm">
          <div className="text-right flex-1">
            <h3 className="text-lg font-semibold text-white">
              {data.items[2].header}
            </h3>
        ...
        {/* Right Item */}
        <div className="absolute -bottom-5 -right-10 transform -translate-y-1/2 flex items-start gap-3 max-w-sm">
          <div className="w-20 h-20 rounded-xl flex items-center justify-center shadow-md shrink-0 bg-white">
