        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
          ...
          <div className="mb-8 sm:mb-10 md:mb-12 lg:mb-14 xl:mb-16 flex flex-col items-center">
            ...
            <p className="mt-4 sm:mt-5 md:mt-6 lg:mt-7 text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 text-center w-full leading-relaxed">
              At Devaicon, we help organizations turn technology into measurable
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 items-stretch w-full">
            ...
            <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-8">
              {introItems.map((item, index) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="flex gap-3 sm:gap-4 md:gap-6 lg:gap-8 animate-fadeInScale"
                    style={{
                  ...
                  >
                    ...
                    <div className="shrink-0 pt-1">
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(180deg, #3d234b 0%, #281333 100%)",
                        }}
                      >
            ...
            {/* Right Side - Image */}
            <div className="flex items-center justify-center relative w-full h-auto min-h-80 sm:min-h-96 md:min-h-112.5 lg:min-h-125 ml-0 lg:ml-9">
              {/* Gradient Circle Background */}
              <div
                className="absolute w-72 h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-120 lg:h-120 xl:w-137.5 xl:h-137.5 rounded-full"
                style={{
                  background:
                    "linear-gradient(180deg, #3d234b 0%, #4a3a6e 100%)",
                  left: "-1.5rem",
                  top: "50%",
